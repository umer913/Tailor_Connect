...
export default function ManageTailors() {
  ...
  const fetchTailors = async () => {
    try {
      const res = await axios.get("https://tailorx-production.up.railway.app/admin/get-tailors");
  ...
  const removeTailor = (email) => {
    Alert.alert("Remove Tailor", "Are you sure?", [
      { text: "Cancel" },
      {
        ...
        onPress: async () => {
          try {
            await axios.delete("https://tailorx-production.up.railway.app/admin/remove-tailor", {
              data: { email },
            });
