...
export default function ManageCustomers() {
  ...
  const fetchCustomers = async () => {
    try {
      const res = await axios.get("https://tailorx-production.up.railway.app/admin/get-customers");
  ...
  const removeCustomer = (email) => {
    Alert.alert("Remove Customer", "Are you sure?", [
      { text: "Cancel" },
      {
        text: "Remove",
        style: "destructive",
        onPress: async () => {
          try {
            await axios.delete("https://tailorx-production.up.railway.app/admin/remove-customer", {
              data: { email },
            });
