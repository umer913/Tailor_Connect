...
const Forgot = ({ navigation }) => {
  ...
  const handleSendOTP = async () => {
    ...
    try {
      const res = await axios.post("https://tailorx-production.up.railway.app:3001/auth/forgot-password", { email });
  ...
  const handleResetPassword = async () => {
    ...
    try {
      const res = await axios.post("https://tailorx-production.up.railway.app:3001/auth/reset-password", {
        email,
        otp,
        newPassword,
      });
