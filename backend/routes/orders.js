...
export const createOrderRouter = ({
  ...
  // ---------------- PLACE ORDER ----------------
  router.post("/place-order", upload.single("fabric"), async (req, res) => {
    try {
      const {
        customer_email,
        tailor_email,
  ...
  // ---------------- PLACE ORDER2 ----------------
  router.post("/place-order2", async (req, res) => {
    try {
  ...
  // ---------- UPDATE ORDER ----------
  router.put("/update-order", upload.single("fabric"), async (req, res) => {
    try {
